<%-- 
    Document   : Restringir_premiun
    Created on : 20/04/2025, 22:14:46
    Author     : T
--%>
...
<html>
    ...
    <body>
       <!-- Seção Restringir ao Premium -->
    <section id="restringir" class="restrict-access-section">
        <div class="card">
            <h2>Restringir ao Premium</h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><%=us.getNome()%></td>
                        <td><%=us.getEmail()%></td>
                        <td><button class="promote" onclick="promoverUsuario('João Silva')">restringiracesso</button></td>
                    </tr>
                </tbody>
                 <%}%>
            </table>
